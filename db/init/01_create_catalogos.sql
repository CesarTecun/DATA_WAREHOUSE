...
-- (1) Inserto departamentos primero, para que la FK en ref_municipios no falle:
...
-- Insertar los municipios (al menos los que aparecen en tus datos)
INSERT INTO ref_municipios (cod_depto, cod_mupio, nombre_mupio) VALUES
  ...
  (1, 105, 'Palencia'),                   -- <--- Asegúrate de incluir este
  (1, 106, 'Chinautla'),
