...
-- NOTA: Las tablas de referencia para vehículos ya fueron creadas en 01_create_catalogos.sql.
-- Aquí solo se insertan los valores de catálogo (no se vuelven a crear).
...
-- ======================================
-- 5) Poblar tablas de referencia geográficas
-- ======================================
...
INSERT INTO ref_municipios (cod_depto, cod_mupio, nombre_mupio) VALUES
  ...
  (22, 2217, 'Quesada')
ON CONFLICT (cod_depto, cod_mupio) DO NOTHING;
